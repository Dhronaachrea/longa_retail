...
class LongaLottoPosTextFieldUnderline extends StatefulWidget {
  const LongaLottoPosTextFieldUnderline({
    Key? key,
    this.hintText,
    this.label,
    this.inputType,
  ...
  @override
  State<LongaLottoPosTextFieldUnderline> createState() =>
      _LongaLottoPosTextFieldUnderlineState();
}

class _LongaLottoPosTextFieldUnderlineState extends State<LongaLottoPosTextFieldUnderline> {
  String? selectedDate;
        ...
        SizedBox(
          child: Focus(
            ...
            child: TextFormField(
              ...
              obscuringCharacter: "*",
              cursorColor: LongaLottoPosColor.black_four,
                  ...
                  InputDecoration(
                    ...
                    enabledBorder: !widget.underLineType!
                        ? OutlineInputBorder(
                            borderSide: BorderSide(
                              color:
                                  widget.borderColor ?? LongaLottoPosColor.black_four,
                              width: 1,
                            ),
                            borderRadius: BorderRadius.circular(8),
                          )
