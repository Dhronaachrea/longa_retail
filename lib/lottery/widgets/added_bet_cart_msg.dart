  ...
  confirmButton(VoidCallback? buttonClick, String buttonText, BuildContext ctx) {
    return InkWell(
      ...
      child: Container(
        ...
        height: 35,
        child: Center(child: Text(ctx.l10n.clear_cap, style: const TextStyle(color: LongaLottoPosColor.white))),
      ),
    );
  }
  ...
  static closeButton(BuildContext ctx) {
    return InkWell(
      ...
      child: Container(
        ...
        height: 35,
        child: Center(child: Text(ctx.l10n.stay, style: const TextStyle(color: LongaLottoPosColor.game_color_red))),
      )
    );
  }
}
